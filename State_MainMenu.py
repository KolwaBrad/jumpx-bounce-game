...
class State_MainMenu(BaseState):
    ...
    def __init__(self, sm : StateManager, rm : ResourceManager, window : pygame.Surface):
        ...
        self.backgroundColor = (128, 0, 128)
    ...
    def __drawUIs(self):
        if self.page == 0:
            ...
            self.AddDrawUIFont("Rajan, Sydney, Winnie, Jeremy and Bradley", Vector2(32, 130), MYCOLOR.WHITE, 30)
            self.AddDrawUIFont("Monalisa instrumental is the background music", Vector2(32, 160), MYCOLOR.WHITE, 30)
            self.AddDrawUIFont("Please give us good marks", Vector2(32, 190), MYCOLOR.WHITE, 30)
            self.AddDrawUIFont("[Enter] Return to main menu", Vector2(32, 400), MYCOLOR.RED, 30)
